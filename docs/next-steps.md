...
## What has been built
1. OSM data sync inbound
   1. Section selection
2. Expedition planner
   1. Team set up
   2. Moving explorers and teams around
   3. Alerts on team size and first aid status
3. Expedition view
...
10. 👎 Leaders view
    ...
    2.  👎 Kit supply
        1.  Per team, tag explorers with tent groups (may differ by exped)
        2.  Per tent group say which unit will supply kit
        3.  View of who I’m supposed to supply kit for
11. Email notifications
    1.  When I’m added to an event (but OSM can handle this?)
    2.  When routes are due
    3.  When training is due
    4.  For adults about upcoming expeds
12. Expedition view enhancements
    1.  Better RTE for editing route planning, maybe with 👎maps integration for start and end points
    2.  👎 Highlight over 18s – but needs us to store DOB
    3.  👎 People in an expedition but not yet in a team
13. Export
    1.  Export various records in PDF, XLS format for sharing with people who don’t have access
