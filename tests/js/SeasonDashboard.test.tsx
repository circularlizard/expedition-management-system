...
describe('SeasonDashboard', () => {
    ...
    it('shows the first aid alert banner when the requirement is not met', () => {
        const data: BoardData = {
            ...mockBoard,
            seasons: [{
                ...mockBoard.seasons[0],
                events: [{
                    ...mockBoard.seasons[0].events[0],
                    ems_first_aid_level: 'full_first_aid',
                    teams: [{
                        ...mockBoard.seasons[0].events[0].teams[0],
                        members: [{ user_id: 1, scout_id: 30001, first_name: 'Alice', last_name: 'MacLeod', first_aid_level: 'first_response' }],
                    }],
                }],
            }],
        };
