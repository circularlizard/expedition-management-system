...
class Admin_PageTest extends EMSTestCase {
    ...
    public function test_register_menus_registers_correct_hierarchy(): void {
        ...
        $this->assertContains( 'ems-participant-signups', $submenu_slugs );
        $this->assertContains( 'ems-expedition-signups', $submenu_slugs );
        ...
        $this->assertContains( 'Participant Places', $submenu_titles );
        $this->assertContains( 'Expedition Signups', $submenu_titles );
