...
class EMSTestCase extends TestCase {
    protected function setUp(): void {
        parent::setUp();
        Monkey\setUp();
        Functions\stubs( [ 'delete_transient', 'get_transient', 'set_transient', 'esc_html__', 'esc_html_e', '__', 'esc_attr_e', 'esc_attr__', 'admin_url', 'sanitize_text_field', 'sanitize_email', 'sanitize_textarea_field', 'esc_url_raw', 'update_option', 'current_time', 'get_current_user_id', 'get_users' ] );
