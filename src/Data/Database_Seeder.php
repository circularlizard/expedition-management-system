        ...
        foreach ( $explorers as $exp ) {
            ...
            if ( $level === 'silver' || $level === 'gold' ) {
                ...
                $e_data = [
                    ...
                    'exped_silver_practice_dates'   => $level === 'silver' ? $practice_dates : [],
                    'exped_silver_qualifier_dates'  => $level === 'silver' ? $qualifier_dates : [],
                    'exped_gold_practice_dates'     => $level === 'gold' ? $practice_dates : [],
                    'exped_gold_qualifier_dates'    => $level === 'gold' ? $qualifier_dates : [],
